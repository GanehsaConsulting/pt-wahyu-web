    ...
    return (
        <div className="md:hidden relative group flex items-center">
            {title ? (
                ...
                >
                    ...
                    <div className="swap-off">
                        <div className={`${iconClassName} p-2 rounded-full bg-white bg-opacity-25 backdrop-blur-md hover:bg-opacity-100 hover:bg-mainColor hover:text-white duration-300 dark:hover:bg-secondaryColor`}>
                            {icon}
                        </div>
                    </div>
                    ...
                    <div className="swap-on">
                        <div className="p-[9px] rounded-lg bg-white text-white bg-opacity-25 backdrop-blur-md hover:bg-opacity-100 hover:bg-mainColor hover:text-white duration-300 dark:hover:bg-secondaryColor">
            ...
            <div
                onMouseEnter={() => setIsExpanded(true)}
                onMouseLeave={() => setIsExpanded(false)}
                className={`-z-50 fixed left-0 right-0 top-0 pt-10 transform opacity-0 max-h-0 pointer-events-none transition-all duration-500 ease-in-out origin-top bg-mainColor dark:bg-opacity-80 bg-opacity-80 backdrop-blur-lg shadow-mainShadow
                    ${isExpanded
                        ?
            ...
            >
                <div className={`${isExpanded ? "flex justify-center md:min-h-fit opacity-100 min-h-screen duration-300 ease-in-out transition-all" : "opacity-0 min-h-0 duration-300 ease-in-out transition-all"} `}>
                    <div className="flex items-center h-[90lvh] gap-6 md:p-8 md:max-w-7xl w-full md:mx-auto p-5">
                        {label ? (
